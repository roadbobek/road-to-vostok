...
func _init():
    var overwrite_0 = preload("res://mods-unpacked/Roadbobek-FurryScavs/overwrites/AI/Bandit/AI_Bandit.tscn")
    overwrite_0.take_over_path("res://AI/Bandit/AI_Bandit.tscn")
...
#
#
#const MOD_DIR = "Roadbobek-InfiniteHealth/" # name of the folder that this file is in
#const MYMOD_LOG = "Roadbobek-InfiniteHealth" # full ID of your mod (AuthorName-ModName)
#
#var dir = ""
#var ext_dir = ""
#
